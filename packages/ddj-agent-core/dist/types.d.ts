...
import type { AssistantMessage, Message, Model, StopReason, ThinkingLevel } from "@ddj-ai/core";
...
export interface AgentTool<T extends TSchema = TSchema> {
    ...
    execute(opts: AgentToolExecuteOptions): Promise<{
        content: import("@ddj-ai/core").ContentBlock[];
...
export type AgentEvent = {
    ...
    type: "message_update";
    assistantMessageEvent: import("@ddj-ai/core").StreamEvent;
    message: AgentAssistantMessage;
} | {
...
export interface AgentConfig {
    ...
    beforeToolCall?(params: BeforeToolCallHookParams): {
        block: boolean;
        reason?: string;
    } | void | Promise<{
        block: boolean;
    ...
    afterToolCall?(params: AfterToolCallHookParams): {
        details?: Record<string, unknown>;
        terminate?: boolean;
    } | void | Promise<{
        details?: Record<string, unknown>;
