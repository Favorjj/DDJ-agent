...
export type Provider = "openai" | "anthropic" | "deepseek" | "google" | "mistral" | "groq" | "cerebras" | "openrouter" | "vercel" | "minimax" | "ollama";
/** Content block types */
...
export type StopReason = "stop" | "toolCalls" | "error" | "aborted" | "unknown";
/** Token usage */
...
export type StreamEvent = EventStart | EventTextStart | EventTextDelta | EventTextEnd | EventThinkingStart | EventThinkingDelta | EventThinkingEnd | EventToolCallStart | EventToolCallDelta | EventToolCallEnd | EventDone | EventError;
